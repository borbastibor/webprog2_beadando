<div class="w3-container w3-padding-large">
    ...
    <div class="w3-container w3-khaki w3-center">
        <h6><?php
            if ($viewData['data'] == null || ['newsdata'] == null) {
        ...
        <div style="padding:20px;">
            <form id="news_edit_form">
                <input type="hidden" id="news_id" value="<?php
                    if ($viewData['data'] != null && $viewData['data']['newsdata'] != null) {
                        echo($viewData['data']['newsdata']['id']);
                    } else {
                        echo(0);
                    }
                ?>">
                <p>
                    ...
                    <input class="w3-input w3-border w3-margin-bottom" type="text" id="cim" placeholder="cím..." value="<?php
                        if ($viewData['data'] != null && $viewData['data']['newsdata'] != null) {
                            echo($viewData['data']['newsdata']['cim']);
                        }
                    ?>" required>
                </p>
                <p>
                    <label>Hír</label>
                    <textarea class="w3-input w3-border w3-margin-bottom" rows="10" id="utonev" placeholder="hír..." value="<?php
                        if ($viewData['data'] != null && $viewData['data']['newsdata'] != null) {
                            echo($viewData['data']['newsdata']['hir']);
                        }
                    ?>" required></textarea>
                </p>
            </form>
